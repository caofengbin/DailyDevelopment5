package cfb.com.dailydevelopment5.example8.drag;
...
/**
 * Created by fengbincao on 2018/3/29.
 */
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        if (mLeft == -1) {
            holder.recommend.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    mLeft = (int) (holder.recommend.getLeft() + layout.getPrimaryHorizontal(0)) - DragListViewActivity.dip2px(mContext, 10);   //textView左边距离+第一个文字绘制的距离 设置了padding 所以要减掉
        ...
        holder.city.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecommend) {
                    ...
                    if (mRight == -1) {
                        mRight = mLeft + holder.city.getLeft() - DragListViewActivity.dip2px(mContext, 10);
                    }
    ...
    class TabHolder extends RecyclerView.ViewHolder {
        ...
        public TabHolder(View itemView) {
            ...
            city = (TextView) itemView.findViewById(R.id.city_channel);
