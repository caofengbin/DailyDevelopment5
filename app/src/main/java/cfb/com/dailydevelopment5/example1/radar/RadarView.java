...
public class RadarView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mLayer = typedArray.getInt(R.styleable.RadarView_radar_layer, 6);
    ...
    protected void onSizeChanged(int w, int h, int oldWidth, int oldHeight) {
        ...
        Log.e(TAG, "onSizeChanged(int w, int h, int oldWidth, int oldHeight)");
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.e(TAG, "onLayout(boolean changed, int left, int top, int right, int bottom)");
    }

    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Log.e(TAG, "onKeyDown(int keyCode, KeyEvent event)");
        return super.onKeyDown(keyCode, event);
    }

    @Override
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        Log.e(TAG, "onKeyUp(int keyCode, KeyEvent event)");
        return super.onKeyUp(keyCode, event);
    }

    @Override
    public boolean onTrackballEvent(MotionEvent event) {
        Log.e(TAG, "onTrackballEvent(MotionEvent event)");
